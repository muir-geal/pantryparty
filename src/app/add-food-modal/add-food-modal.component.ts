  ...
  async saveFood() {
    ...
    const updatedFood = {
      ...
      nutriments: {
        ...
        'energy-kcal_serving': this.food.nutriments?.['energy-kcal_serving'] || 0,
        'energy-kcal_unit': 'kcal',
        'energy-kcal_value': this.energykcal || 0,
        'energy-kcal_value_computed': this.food.nutriments?.['energy-kcal_value_computed'] || 0,
        ...
        'saturated-fat_serving': this.food.nutriments?.['saturated-fat_serving'] || 0,
        'saturated-fat_unit': 'g',
        'saturated-fat_value': this.food.nutriments?.['saturated-fat_value'] || 0,
      ...
      nutriments_estimated: this.food.nutriments_estimated || this.firebaseService.createFoodItem().nutriments_estimated,
